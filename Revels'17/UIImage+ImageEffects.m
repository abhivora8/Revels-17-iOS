...
{
    UIColor *tintColor = [UIColor colorWithWhite:0.3 alpha:0.73];
    return [self applyBlurWithRadius:5 tintColor:tintColor saturationDeltaFactor:4.0 maskImage:nil];
}

- (UIImage *)applyTintEffectWithColor:(UIColor *)tintColor :(float)radius
{
